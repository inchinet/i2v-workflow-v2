...
### 視覺與環境一致性鎖定 (Visual & Location Consistency Lock)
 ...
 1.  **全面鎖定**: 您輸入的「鎖定視覺細節」規則（例如：`保持人物容貌, 衣着, 耳環眼鏡, 化妝, 場景, 日夜, 室外/室內, 除非轉場境`）現在會被**強制**發送給：
...
- `[您在「鎖定視覺細節」欄位中輸入的內容]`：例如「保持人物容貌, 衣着, 耳環眼鏡, 化妝, 場景, 日夜, 室外/室內, 除非轉場境」
